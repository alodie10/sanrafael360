...
export const REVOKE_UNTRUSTED_REST_ACTIONS = [
  ...
  'api::crm-comercio.crm-comercio.find',
  'api::crm-comercio.crm-comercio.findOne',
  'api::crm-comercio.crm-comercio.create',
  'api::crm-comercio.crm-comercio.update',
  'api::crm-comercio.crm-comercio.delete',
  'api::crm-contacto.crm-contacto.find',
  'api::crm-contacto.crm-contacto.findOne',
  'api::crm-contacto.crm-contacto.create',
  'api::crm-contacto.crm-contacto.update',
  'api::crm-contacto.crm-contacto.delete',
  'api::crm-plantilla.crm-plantilla.find',
  'api::crm-plantilla.crm-plantilla.findOne',
  'api::crm-plantilla.crm-plantilla.create',
  'api::crm-plantilla.crm-plantilla.update',
  'api::crm-plantilla.crm-plantilla.delete',
  'api::crm-actividad.crm-actividad.find',
  'api::crm-actividad.crm-actividad.findOne',
