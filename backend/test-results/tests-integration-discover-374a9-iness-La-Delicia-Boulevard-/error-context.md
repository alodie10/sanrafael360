...
- Name: tests/integration/discovery.spec.ts >> Discovery Service Integration >> Should find and extract website for a known business (La Delicia Boulevard)
- Location: tests/integration/discovery.spec.ts:9:7
