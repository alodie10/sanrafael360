...
export default async function EditBusinessPage(props: any) {
  ...
  const isAdmin = session.user?.role?.toLowerCase() === 'admin' || userEmail === 'diegocristianalonso@gmail.com';
  ...
  try {
    ...
    const populateParams = "populate[0]=logo&populate[1]=imagen_portada&populate[2]=galeria&populate[3]=schedules&populate[4]=categoria&populate[5]=owner";
