  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        do {
          const populate = "populate[categoria][fields][0]=nombre&populate[categoria][fields][1]=slug&populate[logo][fields][0]=url&populate[imagen_portada][fields][0]=url";
      ...
      <section className="relative h-[90vh] flex flex-col items-center justify-center text-center px-4">
        ...
        >
          <h1 className="text-5xl md:text-8xl font-serif text-white leading-tight mb-8">
            Vive <span className="italic inline-block text-transparent bg-clip-text bg-gradient-to-r from-primary via-[#FFD700] to-primary-foreground pr-20 pb-4">San Rafael</span>
          </h1>
