  ...
  return (
    <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-xl shadow-lg border border-gray-100 dark:bg-gray-900 mx-auto">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-heading font-bold text-gray-900 dark:text-white">Únete a nosotros</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Registrate de forma rápida y segura con tu cuenta de Google.
        </p>
      </div>
