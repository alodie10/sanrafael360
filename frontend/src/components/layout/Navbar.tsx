  ...
  return (
    <nav
      className={cn(
        ...
        scrolled 
          ? "bg-[#0a0a0a]/95 backdrop-blur-xl border-b border-primary/30 py-3 shadow-[0_8px_30px_rgba(0,0,0,0.5)]" 
          : "bg-[#0a0a0a]/60 backdrop-blur-md border-b border-primary/10"
      )}
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link
            href="/contacto"
            className="flex items-center gap-2 bg-primary text-black px-5 py-2.5 rounded-full font-bold text-sm hover:scale-105 active:scale-95 transition-all shadow-[0_0_20px_rgba(255,191,0,0.3)] hover:shadow-[0_0_30px_rgba(255,191,0,0.4)]"
          >
