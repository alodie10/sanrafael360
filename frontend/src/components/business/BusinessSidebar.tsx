...
export default function BusinessSidebar({ 
  ...
  return (
    <div className="space-y-8">
      {/* Botón de Reclamo (Si aplica) */}
      {negocio.reclamar_habilitado && !negocio.owner && (!negocio.estado_reclamo || negocio.estado_reclamo === 'ninguno') && (
        <div className="p-6 rounded-3xl bg-blue-500/10 border border-blue-500/20 shadow-xl shadow-blue-900/10">
          ...
          <button 
            ...
            className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-all shadow-lg shadow-blue-900/20 active:scale-95"
          >
            Reclamar Perfil
          </button>
        </div>
