...
export default function AdminClaimCard({ claim, jwt, onResolve }: AdminClaimCardProps) {
  ...
  return (
    <div className="bg-zinc-950 border border-white/5 rounded-[2.5rem] overflow-hidden shadow-2xl transition-all hover:border-primary/20 group backdrop-blur-sm">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1 space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-white group-hover:text-primary transition-colors uppercase tracking-tight italic">
                   {claim.nombre}
                 </h3>
                 <div className="flex items-center gap-2 text-zinc-500 text-[10px] font-black uppercase tracking-[0.2em] mt-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-white/5 text-sm">
               <div className="flex items-center gap-3 text-zinc-300">
                ...
                <div>
                  <p className="text-[9px] text-zinc-500 uppercase font-black tracking-widest">Solicitante</p>
                  <p className="font-bold text-xs">{claim.owner?.username || "Usuario San Rafael"}</p>
                </div>
              </div>
               <div className="flex items-center gap-3 text-zinc-300">
                <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center border border-white/5">
                ...
                <div>
                  ...
                  {docUrl ? (
                    ...
                    <p className="text-red-400 text-xs font-bold">Sin archivo adjunto</p>
                  )}
                </div>
              </div>
            </div>
