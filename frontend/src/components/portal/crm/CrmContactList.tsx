...
import { CRM_ESTADOS } from "@/lib/crm";
  ...
  if (!contactos.length) {
    return (
      <p className="text-zinc-500 text-sm" data-testid="crm-empty">
        Todavía no hay contactos en el CRM. Cargá uno a mano o pegá el JSON de la IA.
      </p>
    );
  }
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4 justify-between">
              <div>
                ...
                <p className="text-zinc-500 text-xs mt-1">
                  {c.telefono || "sin teléfono"} · {c.origen} · {c.estado}
                </p>
              </div>
              <div className="flex flex-wrap items-center gap-2">
                ...
                <button
                  ...
                  disabled={busyId === c.documentId || c.no_contactar || !c.telefono}
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {c.negocio?.slug ? (
                  ...
                  <button
                    ...
                    disabled={busyId === c.documentId || !ready}
