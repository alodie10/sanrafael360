...
```
Error: page.goto: Navigation to "http://localhost:3000/portal" is interrupted by another navigation to "http://localhost:3000/login"
Call log:
  - navigating to "http://localhost:3000/portal", waiting until "load"
